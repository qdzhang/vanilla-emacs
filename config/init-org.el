...
(defun my/org-font-setup ()
  ...
  (custom-theme-set-faces
   'user
   `(org-level-1 ((t (:inherit (outline-1 fixed-pitch) :height 1.3 :weight bold))))
   `(org-level-2 ((t (:inherit (outline-2 fixed-pitch) :height 1.2 :weight bold))))
   `(org-level-3 ((t (:inherit (outline-3 fixed-pitch) :height 1.2 :weight bold))))
   `(org-level-4 ((t (:inherit (outline-4 fixed-pitch) :height 1.1 :weight bold))))
   `(org-level-5 ((t (:inherit (outline-5 fixed-pitch) :height 1.1 :weight bold))))
   `(org-level-6 ((t (:inherit (outline-6 fixed-pitch) :height 1.1 :weight bold))))
   `(org-level-7 ((t (:inherit (outline-7 fixed-pitch) :height 1.0 :weight bold))))
   `(org-level-8 ((t (:inherit (outline-8 fixed-pitch) :height 1.0 :weight bold))))
